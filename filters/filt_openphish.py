...
from tahoe import MongoBackend, NoBackend, Instance, \
     Attribute,  Session, parse, UrlObejct #, Object, Event
...
def filt_openphish(backend=_BACKEND):
    try: 
        filt_id = "filter--f2535ab0-61f3-44fa-99b9-8f25f504a1d1"
        
        query = {"itype":"raw", "sub_type":"openphish",
                 # "filters":{"$ne":filt_id},
                 "_valid" : {"$ne" : False}
                 }
